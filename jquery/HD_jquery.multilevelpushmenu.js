      ...
      function startMode( mode ) {
        if( mode ) {
          ...
          if( instance.settings.direction == 'rtl' ) {
            ...
            }, getDuration(instance.settings.durationSlideOut) )
          }
          else {
            $baseLevelHolder.stop().animate({
          ...
          $nextLevelHolders.each(function( key, val ){
            ...
            if( instance.settings.direction == 'rtl' ) {
              $( val ).stop().animate({
                ...
                width: lwidth
              }, getDuration(instance.settings.durationTransition) );
            }
            else {
              $( val ).stop().animate({
                marginLeft : ( (-1) * lwidth ),
            ...
            if( instance.settings.direction == 'rtl' ) {
              $( val ).stop().animate({
                ...
                marginRight : ( $( val ).attr( 'data-level' ) == $baseLevelHolder.attr( 'data-level' ) && collapseAll ) ?
                  ...
                  :
                  0
              }, getDuration(instance.settings.durationSlideOut), function(){
                if( $( val ).attr( 'data-level' ) == $baseLevelHolder.attr( 'data-level' ) && collapseAll ){
                  $baseLevelHolder.children( 'ul' ).first().hide(getDuration(instance.settings.durationSlideDown), function(){
                    $baseLevelHolder.addClass( instance.settings.menuInactiveClass );
                  });
                }
        ...
        if( baseExpand ) {
          ...
          if( instance.settings.direction == 'rtl' ) {
            $baseLevelHolder.stop().animate({
              ...
              $baseLevelHolder.children( 'ul' ).first().show(getDuration(instance.settings.durationSlideDown) , function(){
            ...
            if( setToOpenHolders ) {
              ...
              ieShadowFilterDistortion = 0;
                ...
                if( instance.settings.direction == 'rtl' ) {
                  ...
                  }, getDuration(instance.settings.durationTransition), function(){
